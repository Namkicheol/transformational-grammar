...
4. **2022년 이후**: 루이스 5판 범위 밖 → testmaster의 `refs/2025 전공 기출 김재균해설.md`, `refs/2026 기출 권두걸팀 해설서.md` TG/통사론 파트
...
- 보관함: `/Users/namgicheol/Documents/Obsidian/내 노트`. 공통 안내는 보관함의 `90 운영/자료 관리 원칙.md`, 이 레포의 운영 요약은 `10 교육/교육 프로젝트 목록.md` 안 `transformational-grammar` 프로젝트 구역을 사용한다.
